...
<div class="thankyou-page">
    ...
    <div class="_body">
        <div class="_box">
            ...
            <p>
                Thanks a bunch for verifying your account. It means a lot to us, just like you do! We really appreciate you giving us a moment of your time today. Thanks for being you.
            </p>
        </div>
    </div>
    <div class="_footer">
        <p>Having trouble? <a href="">Contact us</a> </p>
        <a class="btn" href="{{route('guest-index')}}">Back to homepage</a>
    </div>
</div>
@stop
